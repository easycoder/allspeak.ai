...
!   Served by scripted-server.as locally, or any web server with /list, /read, /write routes.
...
!   -- Check for updates --
    ...
    begin
        if confirm `Scripted has been updated. Restart to apply changes?`
        begin
