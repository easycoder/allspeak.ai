...
The variable `Anchor` now becomes the container in which your entire ~ec~ script lives and you can do anything you like with it. For example, go to the _Mexican Wave_ example in the `Codex`, copy its code and paste this into your page inside the `allspeak-script` tag. You'll need to change the line `create Container` to
