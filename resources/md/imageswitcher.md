...
The Image Switcher can be run as an independent web page; see [Image Switcher](https://allspeak.ai/examples/imageswitcher). If you view the page source you will see the entire script inside its special preformatted element.
