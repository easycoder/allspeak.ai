...
The entire script can be seen at the [~ec~ repository](https://raw.githubusercontent.com/allspeak/allspeak.github.io/master/resources/ecs/lifedemo.as). Note: The formatting may look a little uneven because all editing was done in a tabbed editor. There's just one ~ec~ script, comprised mostly of subroutines. Here's a brief description of its functionality:
