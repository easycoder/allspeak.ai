...
AllSpeak is a coding system for AI-powered software development. It is used to create 
...
To test any program you need a debugger. If you are doing cloud-based development you may be using an AI-powered editor such as VS Code. You can set up its tooling to provide full debugging support for either version of AllSpeak or both simultaneously. This can be complicated for the JS version, so ask your agent to do this for you.
