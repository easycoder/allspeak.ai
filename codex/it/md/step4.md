...
~ec~ funziona allo stesso modo dell'italiano (e dell'inglese). Devo essere chiaro su questo punto perché, per qualche curioso motivo, la maggior parte degli altri linguaggi di programmazione fa le cose esattamente al contrario, iniziando i nomi con lettere minuscole e i tipi con lettere maiuscole. Per molti principianti questo è controintuitivo, quindi noi preferiamo seguire la convenzione della lingua naturale.
